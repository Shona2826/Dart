...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    }, "call$2", "call$1", "_nullErrorHandler$closure", 2, 2, 6, 0],
    ...
    NoSuchMethodError_toString_closure: {
      "^": "Closure:12;_core$_box_0,_captured_sb_1",
    ...
    _Html5NodeValidator: {
      ...
      static: {_Html5NodeValidator$: function(uriPolicy) {
          ...
          return true;
        }, "call$4", "_Html5NodeValidator__standardAttributeValidator$closure", 8, 0, 22], _Html5NodeValidator__uriAttributeValidator: [function(element, attributeName, value, context) {
          var t1, t2, t3, t4, t5;
          ...
          if (!t1)
            ...
            t1 = true;
          return t1;
        }, "call$4", "_Html5NodeValidator__uriAttributeValidator$closure", 8, 0, 22]}
    },
    ImmutableListMixin: {
      "^": "Object;",
      get$iterator: function(receiver) {
  ...
  }], ["", "manipulateHTML.dart",, O, {
    "^": "",
    main: [function() {
      O.manipulateHTML();
    }, "call$0", "main$closure", 0, 0, 1],
    manipulateHTML: function() {
      var t1, title, t2, t3, output, divBox, sampDiv, sampAnchor, inputElement;
      t1 = {};
      t1._captured_output_0 = "";
      title = document.querySelector("#sum");
      t2 = J.getInterceptor$x(title);
      t2.setInnerHtml$1(title, "Take me to your leader");
      t3 = title.style;
      t3.color = "Blue";
      t2.get$classes(title).add$1(0, "titleStyle");
      t2 = t2.get$innerHtml(title);
      if (t2 == null)
        return t2.$add();
      output = t2 + "\n";
      t1._captured_output_0 = output;
      divBox = document.querySelector("#divBox");
      sampDiv = document.createElement("div", null);
      sampDiv.textContent = "I'm a DIV";
      t2 = J.getInterceptor$x(divBox);
      t2.get$children(divBox).add$1(0, sampDiv);
      sampAnchor = W.AnchorElement_AnchorElement(null);
      sampAnchor.textContent = "Google";
      sampAnchor.setAttribute("href", "http://google.com");
      sampAnchor.appendChild(document.createTextNode("is here"));
      t1._captured_output_0 = output + ("href of link " + H.S(sampAnchor.getAttribute("href")) + "\n");
      t2.get$children(divBox).add$1(0, sampAnchor);
      t2.get$children(divBox).add$1(0, W._ElementFactoryProvider_createElement_tag("br", null));
      inputElement = W.InputElement_InputElement(null);
      inputElement.setAttribute("id", "inputElement");
      t2.get$children(divBox).add$1(0, inputElement);
      t2 = J.get$onChange$x(document.querySelector("#inputElement"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new O.manipulateHTML_inputElementChange(t1)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      document.querySelector("#output").textContent = t1._captured_output_0;
    },
    manipulateHTML_inputElementChange: {
      "^": "Closure:15;_manipulateHTML0$_box_0",
      call$1: function($event) {
        var t1, t2;
        t1 = document.querySelector("#output");
        t2 = this._manipulateHTML0$_box_0._captured_output_0 + "Input Changed\n";
        t1.textContent = t2;
        return t2;
      }
    }
...
;
  ...
  }, "_attributeValidators", "CssClassSetImpl__validTokenRE", "get$CssClassSetImpl__validTokenRE", function() {
    return new H.JSSyntaxRegExp("^\\S+$", H.JSSyntaxRegExp_makeNative("^\\S+$", false, true, false), null, null);
  }, "_validTokenRE"]);
  Isolate = Isolate.$finishIsolateConstructor(Isolate);
  $ = new Isolate();
  init.metadata = [null];
  init.types = [{func: 1}, {func: 1, void: true}, {func: 1, args: [,]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, args: [{func: 1, void: true}]}, {func: 1, void: true, args: [,], opt: [P.StackTrace]}, {func: 1, args: [,], opt: [,]}, {func: 1, ret: P.bool}, {func: 1, args: [, P.StackTrace]}, {func: 1, void: true, args: [, P.StackTrace]}, {func: 1, args: [,,]}, {func: 1, args: [P.Symbol,,]}, {func: 1, ret: P.String, args: [P.$int]}, {func: 1, void: true, args: [W.Node, W.Node]}, {func: 1, args: [W.MouseEvent]}, {func: 1, void: true, args: [{func: 1, void: true}]}, {func: 1, void: true, args: [,]}, {func: 1, ret: P.bool, args: [,,]}, {func: 1, ret: P.$int, args: [,]}, {func: 1, ret: P.bool, args: [P.Object, P.Object]}, {func: 1, ret: P.$int, args: [P.Object]}, {func: 1, ret: P.bool, args: [W.Element, P.String, P.String, W._Html5NodeValidator]}];
